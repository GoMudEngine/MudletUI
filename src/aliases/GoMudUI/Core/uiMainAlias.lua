...
if command == "" then
  ...
  <gold> ui dev enable             <grey>Enable developer mode
  <gold> ui dev disable            <grey>Disable developer mode
  <gold> ui dev <command>          <grey>Run developer commands (see 'ui dev help')
  ]])
