...
ui.theme.gauges = {
	...
	text = function()
		return (ui.settings and ui.settings.cssFont or "") .. " qproperty-alignment: 'AlignRight|AlignVCenter';"
	end,
	...
	hp = {
		front = function()
			return string.format(
				...
				ui.theme.colors.health.low,
				ui.theme.colors.health.high,
				ui.theme.colors.health.medium,
				ui.theme.colors.health.critical,
	...
	sp = {
		front = function()
			return string.format(
				...
				ui.theme.colors.stamina.medium,
				ui.theme.colors.stamina.high,
				ui.theme.colors.stamina.low,
				ui.theme.colors.stamina.critical,
				ui.theme.components.gaugeBorder()
			)
		end,
	...
	balance = {
		front = function()
			return string.format(
				...
				ui.theme.colors.balance.critical,
				ui.theme.colors.balance.high,
				ui.theme.colors.balance.medium,
				ui.theme.colors.balance.low,
				ui.theme.components.gaugeBorder()
			)
		end,
	...
	enemy = {
		front = function()
			return ui.theme.gauges.hp.front()
		end,

		back = function()
			return ui.theme.gauges.hp.back()
		end,
	},
...
function ui.getStyle(category, name, ...)
