...
local DemonTools = {}
local cheatConsole =
	Geyser.MiniConsole:new({ name = "DemonnicCheatConsole", width = 4000, wrapWidth = 10000, color = "black" })
cheatConsole:hide()
...
local function include(color, options)
	if
		options.removeDupes and (string.find(color, "_") and not color:starts("ansi"))
		or string.find(color:lower(), "gray")
	then
		return false
	end
