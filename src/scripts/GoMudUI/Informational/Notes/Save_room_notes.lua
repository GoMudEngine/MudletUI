function ui.saveRoomNotes(note)
  ...
  if note == "clear" then
    ...
    cecho("\n<DodgerBlue>Room notes saved for room id <green>" ..
    gmcp.Room.Info.num .. " <DodgerBlue>have been cleared.\n\n")
  else
    ui.roomNotes[gmcp.Room.Info.num] = { notes = note }
    cecho("\n<DodgerBlue>Thank you!\n")
    cecho("\n<DodgerBlue>Room notes saved for room id <green>" ..
    gmcp.Room.Info.num .. "<white>: <gold>" .. ui.roomNotes[gmcp.Room.Info.num].notes .. "\n\n")
  end
