function ui.updateWhoDisplay()
  ...
  ui.charDisplay:cecho("Wholist",
    fText.fText("<white>[ <gold>Online players<gold>: <white>" .. #gmcp.Game.Who.Players .. "<white> ]<reset>",
      { alignment = "center", formatType = "c", width = math.floor(ui.charDisplay:get_width() / ui.consoleFontWidth), cap =
      "", spacer = "-", inside = true, mirror = true }))
  ui.charDisplay:cecho("Wholist", "\n")
