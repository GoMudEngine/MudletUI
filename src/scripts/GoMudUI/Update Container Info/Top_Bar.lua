function ui.updateTopBar()
  ...
  ui.topDisplay:cechoLink("<SkyBlue><u>" .. ui.version .. "</u>", [[ui.gomudUIShowFullChangelog()]],
    "Show the GoMud UI changelog", true)
  ...
  if ui.crowdmapVersion then
    ...
    ui.topDisplay:cechoLink("<SkyBlue><u>" .. ui.crowdmapVersion .. "</u>", [[mmp.showcrowdchangelog()]],
      "Show the crowdmap changelog", true)
  end
