...
function ui.showDebug()
    ...
    echo("\n")
    local hasFont = getAvailableFonts()["FiraMono Nerd Font Mono"]
    if hasFont then
        echo("Font FiraMono Nerd Font Mono is available")
    else
        echo("Font FiraMono Nerd Font Mono is NOT available - using the " .. getFont())
    end
    echo("\n")
    ...
    echo("Left border: " ..
        getBorderLeft() ..
        " - Right border: " .. getBorderRight() .. " - Top border: " ..
        getBorderTop() .. " - Bottom Border: " .. getBorderBottom())
    echo("\n")
