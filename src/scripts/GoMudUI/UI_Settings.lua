...
function ui.createSettings()
    ...
    ui.settings = {
        ...
        moveableConsoleCSS =
        "background-color:rgba(15,15,15,100%);border-bottom: 2px solid rgba(40,40,40,100%);padding-top: 10px;",
        ...
        containers = {
            ...
            container9 = { -- Prompt right side
                ...
                y = "-52px",
                customCSS =
                "background-color:rgba(15,15,15,100%);border-bottom: 0px solid rgba(200,15,15,100%);padding-top: 10px;",
                x = "540px"
            },
...
function ui.addCSSToSettings()
    ...
    ui.settings.activeTab = f([[color: white; background-color: ]] ..
    ...
    ui.settings.inactiveTab = f([[color: white; background-color: ]] ..
